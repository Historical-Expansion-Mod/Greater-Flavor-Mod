...
country = {
    ...
    WRONG_REFORM_MILITANCY_IMPACT = 2.5,
...
economy = {
    ...
    SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 2000,
    ...
    TRADE_CAP_LOW_LIMIT_CONSTRUCTIONS = 1.0,         -- the lowest % the slider can go for constructions
