...
country = {
	...
	GOLD_TO_CASH_RATE = 15.0, -- Amount of money generated per gold unit
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 12, -- base value that is powered by level of naval base. Determines the naval supplying capabilities.
	NAVAL_BASE_SUPPLY_SCORE_EMPTY = 2, -- min value for coastal provinces with no naval base.
	NAVAL_BASE_NON_CORE_SUPPLY_SCORE = 0.2, -- modifier for supply score for naval bases that are not in core provinces.
...
military = {
	...
	AI_BIGSHIP_PROPORTION = 0.25, -- fraction of ships in the navy that should be ships of the line
	AI_LIGHTSHIP_PROPORTION = 0.35, -- fraction of ships in the navy that should be cruisers, frigates etc
	...
	AI_ARMY_TAXBASE_FRACTION = 0.25, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
...
diplomacy = {
	...
	WARGOAL_JINGOISM_REQUIREMENT = 0.00, --0.03
	...
	OTHER_CONTINENT_BONUS_INFLUENCE_PERCENT = -0.30, -- Malus to countries on another continent
...
ai =
{
	...
	CHANCE_BUILD_RAILROAD = 0.65, -- chances in % of AI decisions (max value 1.0)
	CHANCE_BUILD_NAVAL_BASE = 0.70,
	...
	MAX_FLEETS = 15, -- Maximal amount of main fleets the AI will divide its navy into (does not include specialized fleets such as blockades and naval invasions)
