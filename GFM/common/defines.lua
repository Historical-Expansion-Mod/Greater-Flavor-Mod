...
country = {
	...
	MOBILIZATION_SPEED_BASE = 0.10, -- Base speed for raising troops Abe edit: used to be 0.1
...
economy = {
	...
	NUM_CLOSED_FACTORIES_PER_STATE_LASSIEZ_FAIRE = 2, -- Number of closed factories allowed per state under Lassiez Faire
	...
	FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.90, -- % of how much we pay to the pops and capitalists, from the leftovers.
	...
	FACTORY_PURCHASE_MIN_FACTOR = 0.75,			-- the lowest % of its daily needs a factory will purchase Abe edit: used to be 0.5
...
military = {
	...
	LEADER_AGE_DEATH_FACTOR = 5, -- higher value means leaders live longer
	...
	LEADER_TRANSFER_PENALTY_ON_COUNTRY_PRESTIGE = 0.05, -- country prestige penalty on unassign leader (f.ex if leader has 100% prestige, the country loose 4% of its prestige) Abe edit: removed
	...
	NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 0.2, -- how little supply is acceptable before getting damage to STR
...
ai =
{
	...
	SOLDIER_FRACTION = 0.045, -- max amount of population AI wants to be soldiers Abe edit: it used to be 0.045 but that makes no sense, the NFs are limited to 0.4
	...
	ONE_SIDE_MAX_WARSCORE = 150, -- don't add too many wargoals to one side in a war Abe edit: used to be 150
	...
	FLEET_SIZE = 150, -- AI will attempt to keep fleets of roughly this size (fewer fleets generally results in more competent naval AI)
