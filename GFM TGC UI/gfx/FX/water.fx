...
const float MAIN_TILING_FACTOR = 1.0;
...
float4 PixelShader_Water_1_1( VS_OUTPUT_WATER IN ) : COLOR
{
	...
	OutColor.rgba += ( TerraIncognita.g - 0.95 )*1.33;
...
const float vWaterTransparens = 1.2; //more transparance lets you see more of background
const float vColorMapFactor = 1.1f; //how much colormap
